...
method sortVersions ($versions) {
	$self->logCaller("");
	$self->logDebug("BEFORE versions: @$versions");
	...
	sub versionSort {
		...
		#print "aVersion: ";
		#print Dumper $aVersion;
		#print "bVersion: ";
		#print Dumper $bVersion;
		
		#print "aVersion->{major}: $aVersion->{major}\n";
		#print "aVersion->{minor}: $aVersion->{minor}\n";
		#print "aVersion->{patch}: $aVersion->{patch}\n";
		#print "aVersion->{release}: $aVersion->{release}\n";
		#print "aVersion->{build}: $aVersion->{build}\n";
		#
		#print "bVersion->{major}: $bVersion->{major}\n";
		#print "bVersion->{minor}: $bVersion->{minor}\n";
		#print "bVersion->{patch}: $bVersion->{patch}\n";
		#print "bVersion->{release}: $bVersion->{release}\n";
		#print "bVersion->{build}: $bVersion->{build}\n";
		#
	...
	$self->logDebug("AFTER versions @$versions");
...
method setVersion ($versionformat, $repodir, $versionfile, $branch, $version, $description) {
	...
	return $self->_setNonSemVer($repodir, $versionfile, $branch, $version, $description);
}
...
method _setVersion($repodir, $versionfile, $branch, $version, $description) {
	...
	#### CHECKOUT BRANCH
	$self->checkoutTag($repodir, $version);
...
method setSemVer ($repodir, $versionfile, $branch, $version, $description) {
	...
	if ( defined $currentversion and $currentversion) {
		$self->logDebug("currentversion is defined", $currentversion);
