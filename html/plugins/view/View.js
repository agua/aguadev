...
updateViewTracklist : function (object) {
	...
	if ( ! success ) {
		console.log("View.updateViewTracklist    Could not do Agua.removeView() for view: " + viewObject.view);
		return;
	}
	success = Agua.addView(object);
	console.log("View.updateViewTracklist    Agua.addView(object) success: " + success);
	console.dir({views:Agua.cloneData("views")});
	if ( ! success ) {
		console.log("View.updateViewTracklist    Could not do Agua.addView() for view: " + viewObject.view);
		return;
	}
...
addView : function (projectName, viewName, speciesBuild) {
	...
	this._addView(dojo.clone(viewObject));
...
// ADD VIEW ON CLIENT
	console.log("View._addView    viewObject:");
	console.dir({viewObject:viewObject});
	
	if ( ! Agua.addView(viewObject) ) {
...
removeView : function () {
	...
	console.log("View.removeBrowser    previousView: ");
	console.dir({previousView:previousView});
	console.log("View.removeBrowser    DOING this.setViewProjectCombo(previousView.project, previousView.view)");
