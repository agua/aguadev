dojo.provide("plugins.workflow.StageStatusRow");


dojo.declare( "plugins.workflow.StageStatusRow",
[ dijit._Widget, dijit._Templated, plugins.core.Common ], {
//Path to the template of this widget. 
templatePath: dojo.moduleUrl("plugins", "workflow/templates/stagestatusrow.html"),
...
startup : function () {
	//console.log("StageStatusRow.startup    plugins.workflow.StageStatusRow.startup()");
...
}); // plugins.workflow.StageStatusRow
