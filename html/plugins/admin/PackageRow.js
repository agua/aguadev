dojo.provide("plugins.admin.PackageRow");

dojo.declare( "plugins.admin.PackageRow",
	[ dijit._Widget, dijit._Templated ],
{
//Path to the template of this widget. 
templatePath: dojo.moduleUrl("plugins", "admin/templates/packagerow.html"),

// Calls dijit._Templated.widgetsInTemplate
widgetsInTemplate : true,

// PARENT plugins.admin.Packages WIDGET
parentWidget : null,
