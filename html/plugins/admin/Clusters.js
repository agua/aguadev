...
dojo.declare("plugins.admin.Clusters",
...
rowClass : "plugins.admin.ClusterRow",
...
constructor : function(args) {
	////////console.log("Clusters.constructor     plugins.admin.Clusters.constructor");			
	// GET INFO FROM ARGS
...
startup : function () {
	console.log("Clusters.startup    plugins.admin.Clusters.startup()");
...
// WHEN INPUTS ARE CLICKED ON
	////console.log("Clusters.setForm    plugins.admin.Clusters.setForm()");
...
setAmiInfo : function (event) {
	console.log("Clusters.setAmiInfo     plugins.admin.Clusters.setAmiInfo(event)");
...
setAvailzoneCombo : function (event) {
	////console.log("Clusters.setAvailzoneCombo     plugins.admin.Clusters.setAvailzoneCombo(event)");
...
setAmiCombo : function () {
	console.log("Clusters.setAmiCombo     plugins.admin.Clusters.setAmiCombo()");
...
// SET THE DRAG SOURCE WITH PARAMETER OBJECTS
	console.log("Clusters.setDragSource     plugins.admin.Clusters.setDragSource()");
...
//	SAVE A PARAMETER TO Agua.parameters AND TO REMOTE DATABASE
	////console.log("Clusters.newCluster    plugins.admin.Clusters.newCluster(inputs, reload)");
...
//	SAVE A PARAMETER TO Agua.parameters AND TO REMOTE DATABASE
	////console.log("Clusters.saveInputs    plugins.admin.Clusters.saveInputs(inputs, reload)");
...
deleteItem : function (clusterObject) {
	////console.log("Clusters.deleteItem    plugins.admin.Clusters.deleteItem(name)");
...
// SET MIN NODES VALUE TO SENSIBLE NUMBER 
	////console.log("Clusters.checkNodeNumbers     plugins.admin.Clusters.checkNodeNumbers()");
