...
setAmiCombo : function (amiid) {
	//console.log("ClusterRow.setAmiCombo     plugins.admin.Clusters.setAmiCombo(amiid)");
...
setAmiInfo : function () {
	//console.log("ClusterRow.setAmiInfo     plugins.admin.Clusters.setAmiInfo()");
...
setAvailzoneCombo : function (event) {
	//console.log("ClusterRow.setAvailzoneCombo     plugins.admin.ClustersRow.setAvailzoneCombo(event)");
