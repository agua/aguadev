...
dojo.declare("plugins.admin.Parameters",
...
cssFiles : [
	dojo.moduleUrl("plugins", "admin/css/parameters.css"),
...
rowClass : "plugins.admin.ParameterRow",
...
constructor : function(args) {
	////console.log("Parameters.constructor     plugins.admin.Parameters.constructor");			
	// GET INFO FROM ARGS
...
startup : function () {
	////console.log("Parameters.startup    plugins.admin.Parameters.startup()");
...
// SET PARAMETERS COMBO BOX
	////console.log("Parameters.setAppTypesCombo     plugins.admin.Parameters.setAppTypesCombo()");
...
/* SET APP NAMES COMBO DEPENDENT ON THE CURRENT SELECTION
	IN THE APP COMBO
*/
	////console.log("Parameters.setAppNamesCombo     plugins.admin.Parameters.setAppNamesCombo()");
...
toggleLock : function () {
	////console.log("Parameters.toggleLock    plugins.admin.Parameters.toggleLock(name)");	
...
// WHEN INPUTS ARE CLICKED ON
	////console.log("Parameters.setForm    plugins.admin.Parameters.setForm()");
...
// DELETE PARAMETER FROM Agua.parameters OBJECT AND IN REMOTE DATABASE
	////console.log("Parameters.deleteItem    plugins.admin.Parameters.deleteItem(name)");
...
saveInputs : function (inputs, updateArgs) {
	...
	////console.log("Parameters.saveInputs    plugins.admin.Parameters.saveInputs(inputs, updateArgs)");
...
getFormInputs : function (widget) {
	////console.log("Parameters.getFormInputs    plugins.admin.Parameterss.getFormInputs(widget)");
...
checkArgsBalance : function(widget) {
	console.log("Parameters.checkArgsBalance    plugins.admin.Parameters.checkArgsBalance(widget)");
...
checkSyntax : function(widget) {
	console.log("Parameters.checkSyntax    plugins.admin.Parameterss.checkSyntax(widget)");
