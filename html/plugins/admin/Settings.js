...
validate: function(/*Boolean*/ isFocused){
	...
	console.log("plugins.admin.ValidationTextBox.validate    this.state: " + this.state);
...
dojo.declare("plugins.admin.Settings",
...
cssFiles : [
	dojo.moduleUrl("plugins", "admin/css/settings.css"),
...
constructor : function(args)  {
	console.log("Settings.constructor     plugins.admin.Settings.constructor");			
	// GET INFO FROM ARGS
...
startup : function () {
	console.log("Settings.startup    plugins.admin.GroupSettings.startup()");
...
passwordsMatch : function () {
	console.log("Settings.confirmPassword    plugins.admin.GroupSettings.confirmPassword()");
...
updateUser : function (event) {
	console.log("Settings.updateUser    plugins.admin.Settings.updateUser(event)");
...
initialiseSettings : function () {
	console.log("Settings.initialiseSettings     plugins.admin.GroupSettings.initialiseSettings()");
...
// RELOAD RELEVANT DISPLAYS
	console.log("Settings.reloadSettingsTabs    plugins.admin.Settings.reloadSettingsTabs()");
...
setTable : function () {
	console.log("Settings.setTable     plugins.admin.GroupSettings.setTable()");
