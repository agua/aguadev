...
//>>excludeEnd("webkitMobile");
	...
	dojo._loadPath = function(/*String*/relpath, /*String?*/module, /*Function?*/cb){
		...
		//console.log("dojo._base._loader.loader    dojo._loadPath    uri: " + uri);

		try{
			currentModule = module;
			//console.log("dojo._base._loader.loader    dojo._loadPath    module: " + module);
	...
	dojo._loadModule = dojo.require = function(/*String*/moduleName, /*Boolean?*/omitModuleCheck){
		...
		//console.log("dojo._base._loader.loader    dojo._loadModule     ************* moduleName: " + moduleName);
		//console.log("dojo._base._loader.loader    dojo._loadPath    d._loadedModules:");
		//console.dir({d__loadeModules:d._loadedModules});

		//console.log("dojo._base._loader.loader    dojo._loadModule    moduleName '" + moduleName + "' module: ");
		//console.dir({module:module});
		
		if(module){
			//console.log("dojo._base._loader.loader    dojo._loadModule    Returning module");
			return module;
		}

		// convert periods to slashes
		var relpath = d._getModuleSymbols(moduleName).join("/") + '.js';
		//console.log("dojo._base._loader.loader    dojo._loadModule     relpath: " + relpath);
	...
	dojo.platformRequire = function(/*Object*/modMap){
		...
		for(var x=0; x<result.length; x++){
			...
			if(curr.constructor == Array){
				//console.log("dojo._base._loader    dojo.platformRequire    Doing d._loadModule.apply(" + d + ", " + curr + ")");

				d._loadModule.apply(d, curr);
			}else{


				//console.log("dojo._base._loader    dojo.platformRequire    Doing d._loadModule(" + curr + ")");
	...
	//console.log("dojo._base._loader.dojo._Url");
