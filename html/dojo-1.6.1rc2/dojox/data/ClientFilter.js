		...
		null,
		{
			...
			cachingFetch: function(args){
				...
				if(!defResult){
					...
					console.log("dojox.data.ClientFilter.querySuperSet    caller: " + this._load.caller.nom);
					console.log("dojox.data.ClientFilter.querySuperSet    Doing defResult= args._loading = this._doQuery(args)");
