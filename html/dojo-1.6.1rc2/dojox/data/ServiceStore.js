...
dojo.declare("dojox.data.ServiceStore",
	...
	dojox.data.ClientFilter||null,{
		...
		fetch: function(args){
			...
			console.log("dojox.data.ServiceStore.fetch    caller: " + this._load.caller.nom);
			console.log("dojox.data.ServiceStore.fetch    Doing var defResult = this.cachingFetch ? this.cachingFetch(args) : this._doQuery(args)");
