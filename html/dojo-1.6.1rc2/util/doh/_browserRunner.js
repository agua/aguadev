...
var d= function(doh) {
	...
	if(topdog){
		...
		doh._updateTestList = function(group, fixture, unwindingBacklog){
			...
			//console.log("doh._updateTestList    _browserRunner    group: " + group);
			//console.log("doh._updateTestList    _browserRunner    fixture: ");
			//console.dir({fixture:fixture});
			//console.log("doh._updateTestList    _browserRunner    unwindingBacklog: ");
			//console.dir({unwindingBacklog:unwindingBacklog});
		...
		doh.registerUrl = function(	/*String*/ group,
			...
			////console.log("this.registerUrl    caller: " + this.registerUrl.caller);
			////console.dir({caller:this.registerUrl});
			////console.log("doh.registerUrl    group: " + group);
			////console.log("doh.registerUrl    url: " + url);
			////console.log("doh.registerUrl    timeout: " + timeout);
...
//				timeout: timeout||10000, // 10s
				...
				runTest: function(){
					...
					////console.log("doh._browserRunner.registerUrl    DOING return this.d");
					////console.dir({this_d:this.d})
		...
		if(_thisGroup){
			...
			//console.log("doh._testRegistered    _browserRunner    group: " + group);
			//console.log("doh._testRegistered    _browserRunner    tObj: ");
