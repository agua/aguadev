...
doh._init = function(){
	...
	//console.log("doh._init    runner    doh: " + doh);
	//console.dir({doh:doh});
...
doh.registerTest = function(/*String*/ group, /*Function||Object*/ test, /*String*/ type){
	...
	//console.log("doh.registerTest    runner    group: " + group);
	//console.log("doh.registerTest    runner    test: ");
	//console.dir({test:test});
	//console.log("doh.registerTest    runner    type: " + type);
	...
	//console.log("doh.registerTest    runner    tObj: ");
	//console.dir({tObj:tObj});
...
doh.registerTests = function(/*String*/ group, /*Array*/ testArr, /*String*/ type){
	...
	//console.log("doh.registerTests    runner    group: " + group);
	//console.log("doh.registerTests    runner    typeof testArr: " + typeof testArr);
	//console.log("doh.registerTests    runner    testArr: ");
	//console.dir({testArr:testArr});
	//console.log("doh.registerTests    runner    type: " + type);
...
doh.register = doh.add = function(groupOrNs, testOrNull, type){
	...
	//console.log("doh.register    runner    groupOrNs: " + groupOrNs);
	//console.log("doh.register    runner    typeof testOrNull: " + typeof testOrNull);
	//console.log("doh.register    runner    testOrNull: ");
	//console.dir({testOrNull:testOrNull});
	//console.log("doh.register    runner    type: " + type);
	...
	if(typeof testOrNull == "string"){
		...
		//console.log("doh.register    runner    typeof testOrNull == 'string' ");

		if(testOrNull.substr(0, 4)=="url:"){
			this.registerUrl(testOrNull, null, null, type);
		}else{
		//console.log("doh.register    runner    DOING this.registerTest(groupOrNs, testOrNull, type)");
	...
	if(doh._isArray(testOrNull)){
		//console.log("doh.register    runner    DOING this.registerTests(groupOrNs, testOrNull, type)");
...
doh._runPerfFixture = function(/*String*/groupName, /*Object*/fixture){
	...
	//console.log("this._runPerfFixture    groupName: " + groupName);
	//console.log("this._runPerfFixture    fixture: " + fixture);
	//console.dir({fixture:fixture});
	...
	if(to > 0) {
		...
		//console.log("this._runPerfFixture    to: " + to);
		//console.log("this._runPerfFixture    DOING timer = setTimeout(function(){...})");


		timer = setTimeout(function(){
			// ret.cancel();
			// retEnd();
			//console.log("this._runPerfFixture    DOING def.errback(new Error(test timeout in " + fixture.name.toString() + ")");
...
doh._runRegFixture = function(/*String*/groupName, /*Object*/fixture){
	...
	//console.log("doh._runRegFixture    fixture: ");
	//console.dir({fixture:fixture});
	...
	if(ret && ret.addCallback){
		...
		var timeoutFunction = function(){
			...
			//console.log("doh._runRegFixture    timeoutFunction    fixture: ");
			//console.dir({fixture:fixture});
			//console.log("doh._runRegFixture    timeoutFunction    DOING def.errback(new Error(XXXX test timeout in " + fixture.name.toString() + ")");
